...
class PostNews(models.Model):
    ...
    title = models.CharField(max_length=50, verbose_name='Напишите название новости', null=True)
    ...
    category_news = models.CharField(max_length=100, choices=CATEGORY_NEWS,
