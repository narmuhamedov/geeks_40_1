...
urlpatterns = [
    ...
    path('phone_list/<int:id>/delete/', views.DeletePhoneView.as_view(), name='delete_phone'),
    path('phone_list/<int:id>/update/', views.EditPhoneView.as_view(), name='update_phone'),
